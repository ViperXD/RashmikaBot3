...
# from RashmikaBot.modules.sql import warns_sql as warnssql
...
from RashmikaBot import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
...
def export_data(update, context):
    ...
    f = open("midukkirashmika3_bot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("midukkirashmika3_bot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `RASHMIKA BOT` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("midukkirashmika3_bot{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 ✪ `/import`: Reply to the backup file for the butler / RASHMIKA MANDANNA group to import as much as possible, making transfers very easy! \
