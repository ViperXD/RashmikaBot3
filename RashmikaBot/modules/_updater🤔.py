...
import heroku3
from RashmikaBot import OWNER_ID, telethn as update


UPSTREAM_REPO_URL = "https://github.com/ALENTL/RashmikaBot3"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        await lol.edit("`Successfully Updated!\n" "restarting......`")
        args = [sys.executable, "-m", "RashmikaBot"]
