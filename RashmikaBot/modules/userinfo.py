...
from RashmikaBot import telethn as SaitamaTelethonClient
...
from RashmikaBot.modules.sql.afk_sql import check_afk_status, is_afk
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID or user.id == RASHMIKA:
        text += "\n\nThe Disaster level of this person is 'God'."
        disaster_level_present = True
    elif user.id in DEV_USERS:

        text += "\n\nThis user is member of 'FOCUS MOVIES'."
        disaster_level_present = True
