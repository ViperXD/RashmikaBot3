...
from RashmikaBot.modules.helper_funcs.handlers import CMD_STARTERS, CustomCommandHandler
...
if is_module_loaded(FILENAME):
    ...
    from RashmikaBot.modules.helper_funcs.chat_status import user_admin, is_user_admin, connection_status
