...
from RashmikaBot.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm [RASHMIKA MANDANNA](https://telegra.ph/file/1ed503f954d7d1fa0477b.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add RASHMIKA MANDANNA to your group 💫",
            url="t.me/midukkirashmika3_bot?startgroup=true",
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [RASHMIKA MANDANNA](https://telegra.ph/file/29dae07ee226f7c63ebe9.jpg)
...
Support them  [ALEN TL](t.me/ALEN_TL,[ALEN TL](https://paypal.me/ALENTL),"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("RashmikaBot.modules." + module_name)
...
@run_async
def RashmikaBot_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by @ALEN_TL.* "
            f"\n\n 🔥 Join [RASHMIKA MANDANNA](https://t.me/focusmoviess) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [support](https://t.me/focusmoviess).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [ROSE](https://github.com/missrose_bot)."
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @ALEN_TL"
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        RashmikaBot_about_callback, pattern=r"aboutmanu_"
    )
