...
from RashmikaBot import DEV_USERS as SUDO_USERS, RASHMIKA
...
def config(client, message):
    ...
    if user.status is "creator" or user.user.id in SUDO_USERS or user.user.id == RASHMIKA:
        chat_id = message.chat.id
...
Note: /FSub is a short name of /ForceSubscribe
