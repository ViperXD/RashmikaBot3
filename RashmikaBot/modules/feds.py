...
from RashmikaBot import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from RashmikaBot.modules.helper_funcs.handlers import CMD_STARTERS
from RashmikaBot.modules.helper_funcs.misc import is_module_loaded, send_to_list
from RashmikaBot.modules.helper_funcs.chat_status import is_user_admin
from RashmikaBot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
    ...
    if args:
        if args[0] == 'json':
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "RashmikaBot_fbanned_users.json"
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(document=output, filename="RashmikaBot_fbanned_users.csv",
