...
from RashmikaBot.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID or new_mem.id == RASHMIKA:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the FOCUS MOVIES just joined!◉‿◉",
                    reply_to_message_id=reply,
                )
                continue
