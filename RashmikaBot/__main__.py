...
from RashmikaBot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
TECHNO_IMG = "https://telegra.ph/file/1ed503f954d7d1fa0477b.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url=f"tg://user?id{OWNER_ID}")],
                                                                                   [InlineKeyboardButton(text="ADD RASHMIKA TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/ALENTL/RashmikaBot3")
                                                                                 ]]))
